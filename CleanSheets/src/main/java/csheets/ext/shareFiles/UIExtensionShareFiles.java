...
import csheets.ext.shareFiles.ui.ShareFilesPanel;
 ...
 */
public class UIExtensionShareFiles extends UIExtension {
	 ...
	 */
	public UIExtensionShareFiles(Extension extension, UIController uiController) {
	...
	public JComponent getSideBar() {
		if (sideBar == null) {
			sideBar = new ShareFilesPanel(uiController);
		}
		return sideBar;
	}
}
