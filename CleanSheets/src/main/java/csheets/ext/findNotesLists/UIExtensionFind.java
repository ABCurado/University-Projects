 ...
 */
public class UIExtensionFind extends UIExtension {
	 ...
	 */
	public UIExtensionFind(Extension extension, UIController uiController) {
	...
	public JComponent getSideBar() {
		if (sideBar == null) {
			sideBar = new FindPanel(uiController);
		}
		return sideBar;
	}
}
