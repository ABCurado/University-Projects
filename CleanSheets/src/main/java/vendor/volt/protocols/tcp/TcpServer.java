...
public class TcpServer extends Server {
	...
	protected void boot(int port) {
		try {
			...
			super.active = false;
			throw new IllegalArgumentException("Could not initiate the TCP service because the given port was already in use. " + ex.
				getMessage());
		}
	}
	...
	protected void protocol(Socket socket, BufferedReader input,
		...
		args.
			put("volt-from", socket.getInetAddress().getHostAddress() + ":" + socket.
				getPort());
