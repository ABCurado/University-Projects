...
public abstract class JpaRepository<T, K extends Serializable>
     ...
     */
    @Override
    public void delete(T entity) throws DataIntegrityViolationException, DataConcurrencyException {
        ...
        try {
            ...
            if (ex.getCause().getClass() == javax.persistence.OptimisticLockException.class) {
     ...
     */
    @Override
    public void deleteById(K entityId) throws DataIntegrityViolationException, DataConcurrencyException {
     ...
     * new object
     *
     * check JPA implementation patterns for a discussion on saveOrUpdate()
     * behavior and merge()
     *
     * @param entity
    ...
    public T save(T entity) throws DataConcurrencyException {
		...
		// if the persist failed due to a locking problem, just throw
                ...
                if (ex.getCause().getClass() == javax.persistence.OptimisticLockException.class) {
                    ...
                    // TODO should encapsulate the JPA exception
                    throw ex;
                }
            }
        } finally {
