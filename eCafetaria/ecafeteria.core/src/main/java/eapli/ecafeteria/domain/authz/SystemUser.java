...
public class SystemUser
	...
	public SystemUser(final String username, final String password,
					  final String firstName, final String lastName,
					  final String email, final Set<RoleType> roles) {
		this(username, password, firstName, lastName, email, roles, DateTime.
			 now());
	}
	...
	public SystemUser(final String username, final String password,
		...
		this.roles.
			addAll(roles.stream().map(rt -> new Role(rt, this.createdOn)).
				collect(Collectors.toList()));

		this.active = true;
	}

	public SystemUser(final Username username, final Password password,
					  final Name name,
	...
	/**
	 * method for change password for a user
	 *
	 * @param newPass
	 */
